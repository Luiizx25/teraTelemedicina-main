<div class="grid grid-cols-12 gap-2">
    <div class="intro-y col-span-12">
        <div class="grid grid-cols-12 gap-2 p-2">
            ...
            <div class="bg-gray-100 text-gray-900 rounded-sm px-2 py-1 w-full col-span-12 sm:col-span-6 lg:col-span-4">
                <label class="text-xs text-gray-600">{{__('Status')}}</label>
                <p class="font-medium flex">
                    <i data-feather="{{ $order->status->ref_icon ?? 'airplay' }}" class="w-4 h-4 mt-1 mr-1"></i> {{ $order->status->ref_description??'--' }}
                </p>
            </div>
            ...
            <div class="bg-gray-100 rounded-sm px-2 py-1 w-full col-span-12 sm:col-span-6 lg:col-span-4">
                <label class="text-xs text-gray-600">{{__('indicacao')}}</label>
                <p class="font-medium">{{ $order->order_description??'--' }}</p>
            </div>
