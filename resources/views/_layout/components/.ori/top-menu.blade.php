        ...
        <div class="top-bar-boxed flex items-center">
                ...
                <div class="search-result">
                    <div class="search-result__content">
                            ...
                            @foreach (array_slice($fakers, 0, 4) as $faker)
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" class="rounded-full" src="{{ asset('dist/images/' . $faker['photos'][0]) }}">
                                    </div>
                        ...
                        @foreach (array_slice($fakers, 0, 4) as $faker)
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" class="rounded-full" src="{{ asset('dist/images/' . $faker['images'][0]) }}">
                                </div>
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110">
                    <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" src="{{ asset('dist/images/' . $fakers[9]['photos'][0]) }}">
                </div>
                <div class="dropdown-box w-56">
                    <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                        <div class="p-4 border-b border-theme-40 dark:border-dark-3">
                            <div class="font-medium">{{ $fakers[0]['users'][0]['name'] }}</div>
                            <div class="text-xs text-theme-41 dark:text-gray-600 truncate">{{ $fakers[0]['jobs'][0] }}</div>
                        </div>
                        <div class="p-2">
