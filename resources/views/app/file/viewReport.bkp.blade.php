                ...
                <table border="0" class="border-b mt-2">
                    <tr>
                        <td width="50%">
                            ...
                            <div class="text-lg -mt-1 p-0 capitalize">{{ strtolower($orderItem->order->pat_name ?? '--') }}</div>
                        </td>
                        <td>
                            <div class="text-xs">Gênero</div>
                            <div class="text-lg -mt-1 p-0 capitalize">{{ strtolower($orderItem->order->pat_genre) }}</div>
                        <td>
                ...
                <table border="0" class="border-b mt-1 mb-2 pb-1">
                    <tr>
                        <td width="50%">
                            ...
                            <div class="text-lg p-0 capitalize">
                ...
                <table border="0" class="border-b mt-1 mb-2 pb-1">
                    <tr>
                        ...
                        <td width="50%">
                            ...
                            <div class="text-lg p-0 capitalize">
                                {{ strtolower($orderItem->order->pat_work_company) }}
                            </div>
                        </td>
                        @endif
                        <!--  -->
                        ...
                        <td width="50%">
                            ...
                            <div class="text-lg p-0 capitalize">
                                {{ strtolower($orderItem->order->pat_work_position) }}
                            </div>
                        </td>
                        @endif
                        <!--  -->
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="text-lg p-0">
                                <p class="m-0 p-0 capitalize truncate">
                                    {{ $orderItem->item_run_datetime ? $orderItem->item_run_datetime->format('d/m/Y') : '--/--/----' }} - {{ strtolower($orderItem->order->order_description ?? 'Indicação não informada.') }}
                                    @if (false && $orderItem->item_comments ?? false)
                                    {{ ' (' . strtolower($orderItem->item_comments ?? ' ') . ').' }}
                                    @endif
                                </p>
                            </div>
                        </td>
