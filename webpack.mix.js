...
mix.js('resources/js/app.js', 'public/dist/js')
    ...
    .copyDirectory('resources/appPzn/js', 'public/app/js')
    .copyDirectory('resources/appPzn/css', 'public/app/css')
    .copyDirectory('resources/appPzn/images', 'public/app/images')
