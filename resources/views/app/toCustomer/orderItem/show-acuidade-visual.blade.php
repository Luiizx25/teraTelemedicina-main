            ...
            <div class="col-span-12 lg:col-span-12">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-content__pane active" id="order_item_request">
                        ...
                        {{-- ANEXOS --}}
                        <div class="intro-y flex flex-col sm:flex-row items-center p-2 mt-2 border-t border-gray-400">
                            <h2 class="text-2xl font-medium mr-auto">{{__('Anexos')}}</h2>
                        ...
                        {{-- FILES --}}
                        <div class="intro-y mx-2 mb-4 pb-4 border-b">
                        ...
                        @if($itemEditActive)
                            <form action="{{route('toCustomer.orderItem.finalizeRegistration',['orderNum'=>$order->order_num,'orderItem'=>$orderItem->id])}}" method="post">
                                ...
                                <div class="intro-y mx-2 mb-4">
                                    <h2 class="text-2xl font-medium mr-auto">{{__('Tabela de Snellen')}}</h2>
                                                    ...
                                                    @foreach (range(1,11) as $n)
                                                        <tr class="border-2 border-gray-400 shadow">
                                                            ...
                                                            <td class="text-center px-4 py-6">
                                                                <input type="checkbox" name="item_fields[OE-N{{ $n }}]" value="{{ old('item_fields[OE-N'.$n.']') }}" class="form-check-input flex-none w-5 h-5" id="item_fields[OE-N{{ $n }}]">
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </table>
                                                ...
                                                <table class="shadow">
                                                    @foreach (range(1,11) as $n)
                                                        <tr class="border-2 border-gray-400 shadow">
                                                            <td class=""><img src="{{ asset('/app/images/exames/tera-acuidade-visual-tabela-de-snellen-'.$n.'.png') }}" alt=""></td>
                                                            <td class="text-center px-4 py-6">
                                                                <input type="checkbox" name="item_fields[OD-N{{ $n }}]" value="{{ old('item_fields[OD-N'.$n.']') }}" class="form-check-input flex-none w-5 h-5" id="item_fields[OD-N{{ $n }}]">
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </table>
                                        ...
                                        <div class="col-span-12 bg-white p-2">
                                            ...
                                            <div class="mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" class="form-radio" name="item_fields[correcao]" value="SIM" required>
                                                    <span class="ml-2">Sim</span>
                                                </label>
                                                <label class="inline-flex items-center ml-6">
                                                    <input type="radio" class="form-radio" name="item_fields[correcao]" value="NÃO">
