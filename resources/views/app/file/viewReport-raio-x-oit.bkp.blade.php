...
<html lang="pt-br" class="light">
    ...
    <body style="background-color: #ffffff !important;">
        <div class="main" style="padding: 0 25px;">
            <table class="border" cellspacing="0px" cellpadding="0px">
                <tr>
                    <td valign="middle" width="35%" style="padding: 5px; text-align: left;">
                    ...
                    <td valign="middle" width="65%" style="padding:5px 15px; text-align: right;">
                        <p style="font-size:16px; font-weight: 600;">
                            FOLHA DE LEITURA RADIOLÓGICA<br />CLASSIFICAÇÃO INTERNACIONAL DE RADIOGRAFIAS DE PNEUMOCONIOSE – OIT
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <table class="border" cellspacing="0px" cellpadding="0px">
                <tr>
                    <td class="border-b-000 border-r-000" valign="middle" width="70%" style="padding: 5px; text-align: left;">
                        NOME: <span class="capitalize bold">{{ strtolower($orderItem->order->pat_name ?? '--') }}</span>
                    </td>
                    <td class="border-b-000" valign="middle" width="30%" style="padding: 5px;">
            ...
            <table class="mb-2 border" cellspacing="0px" cellpadding="0px">
                ...
                <tr>
                    <td class="p-2 text-xs border-b-000" valign="top" colspan="4">
                        ...
                        <div class="p-1 mt-2 font-semibold">
                ...
                <tr>
                    <td valign="middle" width="50%" style="text-align: right;" colspan="2">
                        <div style="text-align: right; padding: 0px 2px;">
