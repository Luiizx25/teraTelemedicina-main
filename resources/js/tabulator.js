...
(function(cash) {
    "use strict";
    // Tabulator
    if (cash('#tabulator111').length) {

        // Setup Tabulator
        let table = new Tabulator("#tabulator111", {
                    ...
                    formatter(cell, formatterParams) {
                        return `<div class="flex lg:justify-center">
                            <div class="intro-x w-10 h-10 image-fit">
                                <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" class="rounded-full" src="/dist/images/${cell.getData().images[0]}">
                            </div>
                            <div class="intro-x w-10 h-10 image-fit -ml-5">
                                <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" class="rounded-full" src="/dist/images/${cell.getData().images[1]}">
                            </div>
                            <div class="intro-x w-10 h-10 image-fit -ml-5">
                                <img alt="inTera - Sistema de Telemedicina da TeraTelemedicina" class="rounded-full" src="/dist/images/${cell.getData().images[2]}">
                            </div>
                        </div>`
                    }
                },
