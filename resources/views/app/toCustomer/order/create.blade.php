                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-12 gap-4 border-t mt-4 pt-4">
                        ...
                        <div class="intro-y col-span-12 lg:col-span-3">
                            ...
                            <input id="pat_work_position" name="pat_work_position" value="{{ old('pat_work_position') }}" type="text" class="input order-none sm:order-2 w-full border flex-1" placeholder="" aria-required111="" required111>
                            @error('pat_work_position')
                            <div class="input-error col-span-7 text-theme-6 mt-2"><strong>{{ __($message) }}</strong></div>
                            @enderror
                        </div>

                        <div class="intro-y col-span-6 lg:col-span-1">
                        ...
                        <div class="intro-y col-span-12 lg:col-span-3">
                            <label>{{__('indicacao')}}</label>
                            <input id="order_description" name="order_description" value="{{ old('order_description') }}" type="text" class="input order-none sm:order-2 w-full border flex-1" placeholder="" aria-required111="" required111>
